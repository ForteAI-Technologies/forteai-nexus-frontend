...
const ViewReports = ({ token, onOpenAdd, onOpenImport, user }) => {
  ...
  const fetchCompanyStatus = async () => {
    try {
      const resp = await fetch('/api/company/report/status', {
        headers: {
          'Authorization': `Bearer ${token}`,
          'Content-Type': 'application/json'
        }
  ...
  const fetchCompanyReport = async () => {
    try {
      setLoading(true);
      const resp = await fetch('/api/company/report', {
        headers: {
          'Authorization': `Bearer ${token}`,
          'Content-Type': 'application/json'
        }
  ...
  const analyzeCompany = async () => {
    try {
      setLoading(true);
      const resp = await fetch('/api/company/analyze', { method: 'POST', headers: { 'Authorization': `Bearer ${token}` } });
      if (!resp.ok) {
  ...
  const fetchEmployeeReport = async (employeeId, employeeName) => {
    try {
      ...
      const response = await fetch(`/api/reports/sentiment/${employeeId}`, {
        headers: {
          'Authorization': `Bearer ${token}`,
          'Content-Type': 'application/json'
        }
                  ...
                  <button
                    ...
                    onClick={async () => {
                      try {
                        setLoading(true);
                        setError('');
                        const response = await fetch(`/api/reports/regenerate/${selectedEmployee.id}`, {
                          method: 'POST',
                ...
                <div className="modal-card">
                  ...
                  <div className="modal-actions">
                    ...
                    <button className="action-button primary" onClick={async () => {
                      ...
                      try {
                        const resp = await fetch(`/api/hr/employee/${selectedEmployee.id}/responses`, {
                          method: 'DELETE',
              ...
              <div className="modal-overlay">
                <div className="modal-card">
                  ...
                  <div className="modal-actions">
                    ...
                    <button className="action-button primary" onClick={async () => {
                      try {
                        const resp = await fetch(`/api/hr/employee/${resetEmployee.employeesID}/responses`, {
